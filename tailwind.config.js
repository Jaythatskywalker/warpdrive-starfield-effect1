...
export default {
  ...
  theme: {
  	extend: {
  		...
  		keyframes: {
            'text-flicker': {
                '0%': { opacity: '0.5', textShadow: '0 0 2px #00FF41, 0 0 5px #F000FF' },
                '5%': { opacity: '1', textShadow: '0 0 4px #00FF41, 0 0 8px #00FF41' },
                '10%': { opacity: '0.6', textShadow: '0 0 3px #00FF41, 0 0 6px #F000FF' },
                '20%': { opacity: '1', textShadow: '0 0 4px #00FF41, 0 0 8px #00FF41' },
                '30%': { opacity: '0.9', textShadow: '0 0 2px #00FF41, 0 0 5px #F000FF' },
                '40%': { opacity: '1', textShadow: '0 0 4px #00FF41, 0 0 8px #00FF41' },
                '100%': { opacity: '1', textShadow: '0 0 4px #00FF41, 0 0 8px #00FF41' },
            },
            'scanline': {
